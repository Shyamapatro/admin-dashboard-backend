...
exports.getSessionDetail = (criteria, projection) => {
	...
	return new Promise((resolve, reject) => {
		Models.session.findOne({ where: criteria, attributes: projection })
			.then(result => {
				resolve(result);
			}).catch(err => {
...
exports.saveSessionData = async (objToSave) => {
	return await baseService.saveData(Models.session, objToSave);
};
/**
 * ######### @function updateData ########
...
exports.updateSessionData =async (criteria, objToSave) => {
	return await baseService.updateData(Models.session, criteria, objToSave);
};
/**
...
exports.deleteSessions = async(criteria) => {
	return await baseService.delete(Models.session, criteria);	
};
