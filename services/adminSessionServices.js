...
exports.getSessionDetail =async (criteria, projection) => {
	return await baseService.getSingleRecord(Models.adminSession, criteria, projection);
};
/**
...
exports.saveSessionData = async(objToSave) => {
	return await baseService.saveData(Models.adminSession, objToSave);	
};
/**
 * ######### @function updateData ########
...
exports.updateSessionData =async (criteria, objToSave) => {
	return await baseService.updateData(Models.adminSession, criteria, objToSave);	
};
/**
...
exports.deleteSessions = async(criteria) => {
	return await baseService.delete(Models.adminSession, criteria);
};